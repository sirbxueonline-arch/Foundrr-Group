...
export default function Contact() {
    ...
    return (
        <div className="min-h-screen bg-slate-900 selection:bg-indigo-500/30 selection:text-indigo-200 pt-40 px-6 font-sans relative overflow-hidden">
            <Background />
            <div className="max-w-2xl mx-auto text-center relative z-10">
                ...
                <div className="space-y-4 animate-fade-up delay-200">
                    ...
                    <a href="https://wa.me/994502411442" target="_blank" className="block w-full p-6 rounded-2xl bg-zinc-900 border border-white/5 hover:border-white/20 transition-all hover:bg-zinc-800 group text-left">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-white font-medium">{t('whatsapp')}</h3>
                                <p className="text-zinc-500 text-sm">Foundrr Support</p>
                            </div>
                        </div>
                    </a>
                </div>
